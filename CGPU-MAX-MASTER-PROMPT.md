...
```css
--primary-bg: #042c53 /* Deep blue (futuristic) */ --accent-blue: #185fa5 /* Intel blue */
  --accent-coral: #993c1d /* AMD coral */ --accent-purple: #534ab7 /* Nvidia accent */
  --success: #0f6e56 /* Balanced/optimal states */ --warning: #ba7517 /* Caution states */
  --danger: #a32d2d /* Bottleneck/critical */ --surface-light: #ffffff --surface-dark: #0a0e1a
  --text-primary: #042c53 --text-secondary: #5f5e5a;
```
